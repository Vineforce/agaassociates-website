...
export const privateCompanyRegistrationData: ServiceData = {
    ...
    accordions: [
      {
        ...
        text:
          "Our streamlined registration process ensures that you can establish your private company quickly and without complications. From gathering the necessary documents to filing with the relevant authorities, we manage each step efficiently, minimizing delays. You can trust us to handle all the paperwork and formalities so that your company is up and running with minimal effort on your part",
      },

      {
        ...
        text:
          "Benefit from our expert advice throughout the company formation process. Whether you’re unsure about the best business structure or need assistance with legal paperwork, we provide personalized guidance tailored to your specific needs. Our team helps you navigate through all the required steps, ensuring compliance and supporting you at every stage, so you can start your business with confidence",
      },

      {
        ...
        text:
          "We ensure your company complies with all local regulations and legal requirements. From incorporation to registration, we handle all documentation and legal formalities, ensuring accuracy and minimizing potential issues, so your company is legally sound and ready to operate",
      },
    ],
  },
  ...
  benefits: [
    ...
    "Personalized Formation Guidance",
