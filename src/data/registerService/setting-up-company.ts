...
export const companyFormationData: ServiceData = {
  title: "Effortless Company Formation",
  ...
  image:
    "/src/assets/images/serviceSection/register-service/setting-up-company/hotel-receptionist-work-scaled.webp",
    ...
    accordions: [
      {
        ...
        text:
          "Simplify the process of registering and setting up your business with our efficient approach. We handle all administrative tasks, ensuring a seamless and stress-free experience whether you’re starting fresh or restructuring",
      },

      {
        ...
        text:
          "We guide you through every stage, from selecting the right business structure to completing legal requirements. Our tailored solutions ensure your business is set up correctly and efficiently",
      },

      {
        ...
        text:
          "Enjoy a fast, error-free registration process that gets your business up and running without delay. We take care of all paperwork and filing, so you can focus on growing your company",
      },
    ],
  },

  benefits: [
    "Efficient and Streamlined Business Setup",
    ...
    "Effortless Documentation and Filing",
    "Fast and Reliable Registration Process",
    "Dedicated Assistance for Every Step",
  ],
};