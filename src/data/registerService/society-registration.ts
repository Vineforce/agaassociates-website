...
export const societyRegistrationData: ServiceData = {
  ...
  image:
    "/src/assets/images/serviceSection/register-service/society-registration/composed-papers-house-miniature-scaled.webp",
    ...
    accordions: [
      {
        ...
        text:
          "Registering your society provides legal recognition, allowing you to operate with a formal, protected structure. This legal status safeguards your operations and ensures that your society is recognized by government bodies and institutions",
      },

      {
        title: "Access to Funding & Resources",

        text:
          "A registered society can access funding from donors, financial institutions, and government grants, giving you the resources to support your mission and initiatives. This opens doors to a wide range of financial opportunities and partnerships",
      },

      {
        ...
        text:
          "Registration boosts your society’s credibility, making it easier to build trust with partners, donors, and the public. It establishes your society as a legitimate entity, paving the way for successful collaborations and long-term growth",
      },
    ],
  },
