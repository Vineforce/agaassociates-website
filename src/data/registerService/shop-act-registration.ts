...
export const societyActRegistrationData: ServiceData = {
  title: "Society Act Registration",

  slug: "society-act-registration",
  ...
  image:
    "/src/assets/images/serviceSection/register-service/shop-act-registration/person-paying-with-its-credit-card.webp",
...
sections: [
  ...
  rightPanel: {
    accordions: [
      {
        title: "Effortless Society Registration",

        text:
          "We simplify the entire process of registering your society, ensuring all legal requirements are met with ease. From document preparation to filing with the relevant authorities, our team manages everything, so you can focus on running your society",
      },

      {
        ...
        text:
          "Registering your society under the Society Act grants you legal recognition, offering protection for your operations. This formal recognition allows you to enter into contracts, manage assets, and gain access to funding from a variety of sources",
      },

      {
        title: "Access to Funding & Growth Opportunities",

        text:
          "A registered society has greater access to grants, donations, and financial institutions. This enables you to raise funds, enhance your credibility, and position your society for long-term growth and success. We help you unlock these opportunities and maximize your potential",
      },
    ],
  },
  ...
  benefits: [
    ...
    "Support with Governance and Management",
  ],
};