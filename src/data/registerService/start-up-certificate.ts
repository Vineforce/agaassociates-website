...
export const startUpCertificateData: ServiceData = {
  title: "Start Up Certificate",

  slug: "start-up-certificate",
  ...
  image:
    "/src/assets/images/serviceSection/register-service/start-up-certificate/laptop-computer-with-marketing-statistics-standing-desk-scaled.webp",
...
sections: [
  ...
  rightPanel: {
    accordions: [
      {
        title: "Easy and Hassle-Free Registration",

        text:
          "Simplify the process of obtaining your Startup Certificate with our guided support, ensuring a smooth and error-free application. We assist you with documentation, eligibility checks, and submission, making the entire process quick and stress-free",
      },

      {
        title: "Access to Tax Benefits & Incentives",

        text:
          "Enjoy tax exemptions, funding opportunities, and government incentives designed to support and accelerate your startup’s growth. With a Startup Certificate, you can reduce financial burdens, attract investors, and take advantage of exclusive startup-friendly policies",
      },

      {
        title: "Compliance and Legal Assistance",

        text:
          "Ensure your business meets all regulatory requirements with our expert guidance, avoiding delays and legal complications. We help you understand the legal framework, submit the necessary documents, and stay compliant with government norms, giving your business a strong foundation",
      },
    ],
  },
  ...
  benefits: [
    ...
    "Hassle-Free Tax Filing Support",
  ],
};