...
export const trademarkRegistrationData: ServiceData = {
  ...
  image:
    "/src/assets/images/serviceSection/register-service/trademark-registration/people-checking-bankbook-isolated-white-table-scaled.webp",
...
sections: [
  ...
  rightPanel: {
    accordions: [
      {
        title: "Complete Brand Protection",

        text:
          "Secure exclusive rights to your brand name, logo, and slogans, preventing unauthorized use and protecting your business identity",
      },

      {
        ...
        text:
          "Enjoy a hassle-free registration experience with step-by-step assistance, ensuring timely and accurate submission of your application",
      },

      {
        title: "Enhance Brand Value and Credibility",

        text:
          "A registered trademark boosts your brand’s reputation, builds customer trust, and increases your business’s market value",
      },
    ],
  },

  benefits: [
    "Exclusive Legal Protection Rights",
    "Clear Market Brand Differentiation",
    "Increased Long-Term Brand Value",
    "Enhanced Customer Trust & Loyalty",
    "Trademark Infringement Legal Protection",
    "Stronger Brand Recognition Globally",
    "Prevention of Unauthorized Use",
    "Improved Business Credibility & Authority",
    "Asset Growth & Market Security",
  ],
};