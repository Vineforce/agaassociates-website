...
export const partnershipFirmRegistrationData: ServiceData = {
  ...
  image:
    "/src/assets/images/serviceSection/register-service/partnership-firm-registration/hand-investment-income-return-results-management-scaled.jpg",
  ...
  rightPanel: {
    accordions: [
      {
        title: "Guidance for Seamless Registration",

        text:
          "Our experienced team provides personalized guidance throughout the entire registration process, ensuring that all legal requirements are met and helping you avoid common mistakes. With our support, you can navigate the complexities of registration with confidence",
      },

      {
        ...
        text:
          "A registered partnership firm offers legal protection, enabling you to operate your business under a recognized name. This enhances your credibility with clients, vendors, and financial institutions, giving you a competitive edge in the market",
      },

      {
        title: "Efficient Process with Minimal Hassle",

        text:
          "We simplify the registration process to ensure it’s completed swiftly and without unnecessary complications. Our team handles all the paperwork and formalities, allowing you to focus on running and expanding your business with minimal disruption",
      },
    ],
  },
